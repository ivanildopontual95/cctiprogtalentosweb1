...
<div class="container">
    ...
    <div class="row">
        <div class="card-panel white">
            <div class="row">
                <form class="form-horizontal" action="{{route('dashboard.publicacao.relatorios.PDFcurriculo', $inscricao->id)}}">
                    {{csrf_field()}}
                    ...
                    <div class="col s12">
                        ...
                        <div class="input-field col s6">
                            <input id="disabled" type="text" name="telefone" id="telefone" pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4,5}" class='validate'
                                value="{{ isset($inscricao->telefone) && !old('telefone') ? $inscricao->telefone : '' }}{{old('telefone')}}">
                            <label>Contato</label>
                        </div>
                    </div>
                    <button class="btn green right">Baixar</button>
                </form>
            </div>
        </div>
    </div>
