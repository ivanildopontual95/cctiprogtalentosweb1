...
<head>
    <title>Lista de Deferimentos</title>
    <style type="text/css">
        table {
            border-spacing: 1;
...
<body>
    <div class="table100">
        <table>
            <caption>
                <h3> Lista de Deferimentos - {{$publicacao->titulo}}</h3>
            </caption>
            <thead>
                <tr class="table100-head">
                    ...
                    <th class="column4">Deferimento</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="column4">{{ $inscricao->deferimento }}</td>
